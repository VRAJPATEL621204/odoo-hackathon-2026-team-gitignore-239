 ...
 * 
 * Can be dropped into any React application with zero dependencies on mock dashboards.
 * 
 * @param {Object} props
 * @param {string} [props.apiUrl='http://localhost:4500'] - URL of the AI Chatbot backend server
 * @param {Object} [props.user] - Authenticated user context { id, name, role, token }
 * @param {Function} [props.onNavigate] - Callback invoked when a quick-link or contextual action is clicked: (routePath) => void
 * @param {boolean} [props.defaultOpen=false] - Whether the modal starts open or as a Floating Action Button
 * @param {Array} [props.quickLinks] - Custom portal navigation destinations for your actual app
 */
export default function AiChatbotWidget({
  apiUrl = 'http://localhost:4500',
  user = { id: 'emp_001', name: 'User', token: '' },
