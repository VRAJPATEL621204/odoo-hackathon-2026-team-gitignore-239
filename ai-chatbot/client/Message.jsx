      ...
      <div className="md-chat-bubble">
        ...
        {type === 'NAVIGATION' && msg.navigationId && NAVIGATION[msg.navigationId] && (
          <div className="md-msg-actions">
            ...
            >
              <span>Open {msg.navigationId[0] + msg.navigationId.slice(1).toLowerCase()} Portal</span>
